...
export class PrivacyPolicyComponent {
  ...
  products: Product[] = [
    ...
    { name: 'Pine Apple', image: 'https://cdn.pixabay.com/photo/2011/03/24/11/05/pineapple-5794_960_720.jpg', description: 'The pineapple (Ananas comosus) is a tropical plant with an edible fruit; it is the most economically significant plant in the family Bromeliaceae.)', price: 36, },
